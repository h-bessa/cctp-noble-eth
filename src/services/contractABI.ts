const contractABI:Array<object> = [{
    "inputs": [{
        "internalType": "uint32",
        "name": "_localDomain",
        "type": "uint32"
    ...
    "inputs": [{"internalType": "bytes", "name": "originalMessage", "type": "bytes"}, {
        "internalType": "bytes",
        ...
        "type": "bytes32"
    }], "name": "replaceMessage", "outputs": [], "stateMutability": "nonpayable", "type": "function"
}, {
    "inputs": [{
